...
HACS installation uses a custom repository; default-store inclusion is not claimed.
See [installation](docs/installation.md) for the complete procedure and checks.
